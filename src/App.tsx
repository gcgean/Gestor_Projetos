...
import {
  ...
  Plus, Search, Settings2, ShieldAlert, Sparkles, Sun, Target, Trash2, WalletCards, X,
} from 'lucide-react'
...
function App() {
  ...
  const filteredProjects = useMemo(() => projectFilter === 'Todos os projetos' ? projects : projects.filter(project => project.name === projectFilter), [projectFilter, projects])
